...
public class WorldData {
    private static final AtomicLongFieldUpdater<WorldData> currentTickUpdater = AtomicLongFieldUpdater.newUpdater(
            WorldData.class, "currentTick");
    ...
    public WorldData(WorldData worldData) {
        this.gameRules.putAll(worldData.gameRules);
        this.generator = worldData.generator;
        this.generatorOptions = worldData.generatorOptions;
        this.name = worldData.name;
        this.spawn = worldData.spawn;
        this.serverChunkTickRange = worldData.serverChunkTickRange;
        this.spawnRadius = worldData.spawnRadius;
        this.rainTime = worldData.rainTime;
        this.lightningTime = worldData.lightningTime;
        this.rainLevel = worldData.rainLevel;
        this.lightningLevel = worldData.lightningLevel;
