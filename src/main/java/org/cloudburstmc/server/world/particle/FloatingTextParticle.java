...
public class FloatingTextParticle extends Particle {
    ...
    public FloatingTextParticle(World world, Vector3f pos, String title) {
        this(world, pos, title, null);
    }
    ...
    public FloatingTextParticle(World world, Vector3f pos, String title, String text) {
        super(pos);
        this.world = world;
    ...
    private void sendMetadata() {
        if (this.world != null) {
            ...
            this.world.addChunkPacket(this.getPosition(), packet);
        }
    }
