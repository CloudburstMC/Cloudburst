package org.cloudburstmc.server.world.generator.standard.generation.density;
...
import org.cloudburstmc.server.world.generator.standard.registry.StandardGeneratorRegistries;
...
final class DensitySourceDeserializer extends JsonDeserializer<DensitySource> {
    ...
    public DensitySource deserialize(JsonParser p, DeserializationContext ctxt) throws IOException, JsonProcessingException {
        ...
        try {
            return Bootstrap.YAML_MAPPER.readValue(p, StandardGeneratorRegistries.densitySource().get(id));
        } catch (Exception e) {
