...
public abstract class MetadataStore {
    ...
    private final Map<String, Map<PluginContainer, MetadataValue>> metadataMap = new HashMap<>();
    ...
    public void setMetadata(Object subject, String metadataKey, MetadataValue newMetadataValue) {
        ...
        PluginContainer owningPlugin = newMetadataValue.getOwningPlugin();
        if (owningPlugin == null) {
            throw new PluginException("Plugin cannot be null");
        }
        String key = this.disambiguate((Metadatable) subject, metadataKey);
        Map<PluginContainer, MetadataValue> entry = this.metadataMap.computeIfAbsent(key, k -> new WeakHashMap<>(1));
    ...
    public void removeMetadata(Object subject, String metadataKey, PluginContainer owningPlugin) {
        if (owningPlugin == null) {
            throw new PluginException("Plugin cannot be null");
        }
        String key = this.disambiguate((Metadatable) subject, metadataKey);
    ...
    public void invalidateAll(PluginContainer owningPlugin) {
        if (owningPlugin == null) {
            throw new PluginException("Plugin cannot be null");
        }
