...
import org.cloudburstmc.server.item.enchantment.bow.EnchantmentBowPower;
import org.cloudburstmc.server.item.enchantment.damage.EnchantmentDamageAll;
import org.cloudburstmc.server.item.enchantment.damage.EnchantmentDamageArthropods;
import org.cloudburstmc.server.item.enchantment.damage.EnchantmentDamageSmite;
import org.cloudburstmc.server.item.enchantment.loot.EnchantmentLootDigging;
import org.cloudburstmc.server.item.enchantment.loot.EnchantmentLootFishing;
import org.cloudburstmc.server.item.enchantment.loot.EnchantmentLootWeapon;
import org.cloudburstmc.server.item.enchantment.protection.*;
import org.cloudburstmc.server.item.enchantment.trident.EnchantmentTridentChanneling;
import org.cloudburstmc.server.item.enchantment.trident.EnchantmentTridentImpaling;
import org.cloudburstmc.server.item.enchantment.trident.EnchantmentTridentLoyalty;
import org.cloudburstmc.server.item.enchantment.trident.EnchantmentTridentRiptide;
