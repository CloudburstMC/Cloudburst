...
public class ItemTypes {
    ...
    public static final ItemType SIGN = IntItem.builder().id(ItemIds.SIGN).maxStackSize(16).blockType(BlockTypes.STANDING_SIGN).data(TreeSpecies.class).build();
    public static final ItemType WOODEN_DOOR = IntItem.builder().id(ItemIds.WOODEN_DOOR).maxStackSize(64).blockType(BlockTypes.WOODEN_DOOR).data(TreeSpecies.class).build();
