...
import org.cloudburstmc.server.math.Angle;
...
class AngleTest {
	...
	@Test
	void testAngle() {
		Angle rd1 = Angle.fromRadian(1.0);
		Angle rf1 = Angle.fromRadian(1.0f);
		Angle dd1 = Angle.fromDegree(180.0);
		Angle df1 = Angle.fromDegree(180.0f);
		...
		Angle rd2 = Angle.fromRadian(200.0);
		Angle rf2 = Angle.fromRadian(200.0f);
		Angle dd2 = Angle.fromDegree(23333.33);
		Angle df2 = Angle.fromDegree(23333.33f);
		...
		Angle asin1 = Angle.asin(1);
		Angle asin2 = Angle.asin(1.0 / 2.0);
		Angle acos1 = Angle.acos(1);
		Angle acos2 = Angle.acos(1.0 / 2.0);
		Angle atan1 = Angle.atan(1);
		Angle atan2 = Angle.atan(1.0 / 2.0);
