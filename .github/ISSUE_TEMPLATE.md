<!--- Please do not ask questions or create discussion in the bug tracker. Use https://cloudburstmc.org -->
...
<!--- Use the 'debugpaste' and 'timings paste' command in Cloudburst -->
...
- [] I made sure there aren't duplicates of this report [(Use Search)](https://github.com/CloudburstMC/Cloudburst/issues)
- [] I made sure I am using an up-to-date version of Cloudburst
