...
public final class BlockComponents {
    ...
    public static final ComponentType<BooleanBlockStateHandler> CAN_PASS_THROUGH = ComponentType.of("can_pass_through", BooleanBlockStateHandler.class);
    ...
    public static final ComponentType<AABBBlockHandler> GET_BOUNDING_BOX = ComponentType.of("get_bounding_box", AABBBlockHandler.class);
    ...
    public static final ComponentType<BooleanTypeHandler> SOLID = ComponentType.of("solid", BooleanTypeHandler.class);
