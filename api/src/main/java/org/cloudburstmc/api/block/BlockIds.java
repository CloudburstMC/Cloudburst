...
public final class BlockIds {
    ...
    public static final Identifier BIG_DRIPLEAF = Identifier.fromString("big_dripleaf");
    ...
    public static final Identifier BUDDING_AMETHYST = Identifier.fromString("budding_amethyst");
    ...
    public static final Identifier CAVE_VINES = Identifier.fromString("cave_vines");
    public static final Identifier CAVE_VINES_BODY_WITH_BERRIES = Identifier.fromString("cave_vines_body_with_berries");
    public static final Identifier CAVE_VINES_HEAD_WITH_BERRIES = Identifier.fromString("cave_vines_head_with_berries");
    ...
    public static final Identifier CHISELED_DEEPSLATE = Identifier.fromString("chiseled_deepslate");
    ...
    public static final Identifier CLIENT_REQUEST_PLACEHOLDER_BLOCK = Identifier.fromString("client_request_placeholder_block");
    ...
    public static final Identifier COPPER_BLOCK = Identifier.fromString("copper_block");
    public static final Identifier COPPER_ORE = Identifier.fromString("copper_ore");
    ...
    public static final Identifier DEEPSLATE = Identifier.fromString("deepslate");
    public static final Identifier DEEPSLATE_BRICKS = Identifier.fromString("deepslate_bricks");
    public static final Identifier DEEPSLATE_BRICK_DOUBLE_SLAB = Identifier.fromString("deepslate_brick_double_slab");
    public static final Identifier DEEPSLATE_BRICK_SLAB = Identifier.fromString("deepslate_brick_slab");
    public static final Identifier DEEPSLATE_BRICK_STAIRS = Identifier.fromString("deepslate_brick_stairs");
    public static final Identifier DEEPSLATE_BRICK_WALL = Identifier.fromString("deepslate_brick_wall");
    public static final Identifier DEEPSLATE_COAL_ORE = Identifier.fromString("deepslate_coal_ore");
    public static final Identifier DEEPSLATE_COPPER_ORE = Identifier.fromString("deepslate_copper_ore");
    public static final Identifier DEEPSLATE_DIAMOND_ORE = Identifier.fromString("deepslate_diamond_ore");
    ...
    public static final Identifier EXPOSED_COPPER = Identifier.fromString("exposed_copper");
    public static final Identifier EXPOSED_CUT_COPPER = Identifier.fromString("exposed_cut_copper");
    public static final Identifier EXPOSED_CUT_COPPER_SLAB = Identifier.fromString("exposed_cut_copper_slab");
    public static final Identifier EXPOSED_CUT_COPPER_STAIRS = Identifier.fromString("exposed_cut_copper_stairs");
    public static final Identifier EXPOSED_DOUBLE_CUT_COPPER_SLAB = Identifier.fromString("exposed_double_cut_copper_slab");
    ...
    public static final Identifier FLOWERING_AZALEA = Identifier.fromString("flowering_azalea");
    ...
    public static final Identifier FROG_SPAWN = Identifier.fromString("frog_spawn");
    ...
    public static final Identifier GLOW_FRAME = Identifier.fromString("glow_frame");
    public static final Identifier GLOW_LICHEN = Identifier.fromString("glow_lichen");
    ...
    public static final Identifier INFESTED_DEEPSLATE = Identifier.fromString("infested_deepslate");
    ...
    public static final Identifier INVISIBLE_BEDROCK = Identifier.fromString("invisible_bedrock");
    ...
    public static final Identifier LARGE_AMETHYST_BUD = Identifier.fromString("large_amethyst_bud");
    ...
    public static final Identifier MOSS_BLOCK = Identifier.fromString("moss_block");
    ...
    public static final Identifier MUD_BRICK_STAIRS = Identifier.fromString("mud_brick_stairs");
    public static final Identifier MUD_BRICK_WALL = Identifier.fromString("mud_brick_wall");
    ...
    public static final Identifier OAK_PLANKS = Identifier.fromString("planks");
    public static final Identifier OAK_PRESSURE_PLATE = Identifier.fromString("wooden_pressure_plate");
    public static final Identifier OAK_SLAB = Identifier.fromString("wooden_slab");
    ...
    public static final Identifier OCHRE_FROGLIGHT = Identifier.fromString("ochre_froglight");
    ...
    public static final Identifier OXIDIZED_CUT_COPPER_SLAB = Identifier.fromString("oxidized_cut_copper_slab");
    ...
    public static final Identifier PACKED_MUD = Identifier.fromString("packed_mud");
    public static final Identifier PEARLESCENT_FROGLIGHT = Identifier.fromString("pearlescent_froglight");
    ...
    public static final Identifier PISTON_ARM_COLLISION = Identifier.fromString("piston_arm_collision");
    public static final Identifier PODZOL = Identifier.fromString("podzol");
    public static final Identifier POINTED_DRIPSTONE = Identifier.fromString("pointed_dripstone");
    ...
    public static final Identifier POLISHED_DEEPSLATE = Identifier.fromString("polished_deepslate");
    public static final Identifier POLISHED_DEEPSLATE_DOUBLE_SLAB = Identifier.fromString("polished_deepslate_double_slab");
    public static final Identifier POLISHED_DEEPSLATE_SLAB = Identifier.fromString("polished_deepslate_slab");
    public static final Identifier POLISHED_DEEPSLATE_STAIRS = Identifier.fromString("polished_deepslate_stairs");
    public static final Identifier POLISHED_DEEPSLATE_WALL = Identifier.fromString("polished_deepslate_wall");
    ...
    public static final Identifier POWDER_SNOW = Identifier.fromString("powder_snow");
    ...
    public static final Identifier REINFORCED_DEEPSLATE = Identifier.fromString("reinforced_deepslate");
    ...
    public static final Identifier SCULK = Identifier.fromString("sculk");
    public static final Identifier SCULK_CATALYST = Identifier.fromString("sculk_catalyst");
    public static final Identifier SCULK_SENSOR = Identifier.fromString("sculk_sensor");
    public static final Identifier SCULK_SHRIEKER = Identifier.fromString("sculk_shrieker");
    public static final Identifier SCULK_VEIN = Identifier.fromString("sculk_vein");
    public static final Identifier SEAGRASS = Identifier.fromString("seagrass");
    public static final Identifier SEA_LANTERN = Identifier.fromString("sea_lantern");
    ...
    public static final Identifier SMALL_AMETHYST_BUD = Identifier.fromString("small_amethyst_bud");
    public static final Identifier SMALL_DRIPLEAF_BLOCK = Identifier.fromString("small_dripleaf_block");
    ...
    public static final Identifier SMOOTH_BASALT = Identifier.fromString("smooth_basalt");
    ...
    public static final Identifier SPORE_BLOSSOM = Identifier.fromString("spore_blossom");
    ...
    public static final Identifier STICKY_PISTON_ARM_COLLISION = Identifier.fromString("sticky_piston_arm_collision");
    ...
    public static final Identifier TINTED_GLASS = Identifier.fromString("tinted_glass");
    ...
    public static final Identifier TRIP_WIRE = Identifier.fromString("trip_wire");
    public static final Identifier TUFF = Identifier.fromString("tuff");
    ...
    public static final Identifier VERDANT_FROGLIGHT = Identifier.fromString("verdant_froglight");
    ...
    public static final Identifier WAXED_COPPER = Identifier.fromString("waxed_copper");
    public static final Identifier WAXED_CUT_COPPER = Identifier.fromString("waxed_cut_copper");
    public static final Identifier WAXED_CUT_COPPER_SLAB = Identifier.fromString("waxed_cut_copper_slab");
    public static final Identifier WAXED_CUT_COPPER_STAIRS = Identifier.fromString("waxed_cut_copper_stairs");
    public static final Identifier WAXED_DOUBLE_CUT_COPPER_SLAB = Identifier.fromString("waxed_double_cut_copper_slab");
    public static final Identifier WAXED_EXPOSED_COPPER = Identifier.fromString("waxed_exposed_copper");
    public static final Identifier WAXED_EXPOSED_CUT_COPPER = Identifier.fromString("waxed_exposed_cut_copper");
    public static final Identifier WAXED_EXPOSED_CUT_COPPER_SLAB = Identifier.fromString("waxed_exposed_cut_copper_slab");
    public static final Identifier WAXED_EXPOSED_CUT_COPPER_STAIRS = Identifier.fromString("waxed_exposed_cut_copper_stairs");
    public static final Identifier WAXED_EXPOSED_DOUBLE_CUT_COPPER_SLAB = Identifier.fromString("waxed_exposed_double_cut_copper_slab");
    public static final Identifier WAXED_OXIDIZED_COPPER = Identifier.fromString("waxed_oxidized_copper");
    public static final Identifier WAXED_OXIDIZED_CUT_COPPER = Identifier.fromString("waxed_oxidized_cut_copper");
    public static final Identifier WAXED_OXIDIZED_CUT_COPPER_SLAB = Identifier.fromString("waxed_oxidized_cut_copper_slab");
    public static final Identifier WAXED_OXIDIZED_CUT_COPPER_STAIRS = Identifier.fromString("waxed_oxidized_cut_copper_stairs");
    public static final Identifier WAXED_OXIDIZED_DOUBLE_CUT_COPPER_SLAB = Identifier.fromString("waxed_oxidized_double_cut_copper_slab");
    public static final Identifier WAXED_WEATHERED_COPPER = Identifier.fromString("waxed_weathered_copper");
    public static final Identifier WAXED_WEATHERED_CUT_COPPER = Identifier.fromString("waxed_weathered_cut_copper");
