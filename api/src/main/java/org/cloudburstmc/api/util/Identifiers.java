...
public class Identifiers {
    ...
    //Potions
    public static final Identifier POTION_WATER = Identifier.fromString("potion_water");
    public static final Identifier POTION_MUNDANE = Identifier.fromString("potion_mundane");
    public static final Identifier POTION_MUNDANE_II = Identifier.fromString("potion_mundane_2");
    public static final Identifier POTION_THICK = Identifier.fromString("potion_thick");
    public static final Identifier POTION_AWKWARD = Identifier.fromString("potion_awkward");
    public static final Identifier POTION_NIGHT_VISION = Identifier.fromString("potion_night_vision");
    public static final Identifier POTION_NIGHT_VISION_LONG = Identifier.fromString("potion_night_vision_long");
    public static final Identifier POTION_INVISIBLE = Identifier.fromString("potion_invisible");
    public static final Identifier POTION_INVISIBLE_LONG = Identifier.fromString("potion_invisible_long");
    public static final Identifier POTION_LEAPING = Identifier.fromString("potion_leaping");
    public static final Identifier POTION_LEAPING_LONG = Identifier.fromString("potion_leaping_long");
    public static final Identifier POTION_LEAPING_II = Identifier.fromString("potion_leaping_2");
    public static final Identifier POTION_FiRE_RESISTANCE = Identifier.fromString("potion_fire_resistance");
    public static final Identifier POTION_FIRE_RESISTANCE_LONG = Identifier.fromString("potion_fire_resistance_long");
    public static final Identifier POTION_SPEED = Identifier.fromString("potion_speed");
    public static final Identifier POTION_SPEED_LONG = Identifier.fromString("potion_speed_long");
    public static final Identifier POTION_SPEED_II = Identifier.fromString("potion_speed_2");
    public static final Identifier POTION_SLOWNESS = Identifier.fromString("potion_slowness");
    public static final Identifier POTION_SLOWNESS_LONG = Identifier.fromString("potion_slowness_long");
    public static final Identifier POTION_WATER_BREATHING = Identifier.fromString("potion_water_brething");
    public static final Identifier POTION_WATER_BREATHING_LONG = Identifier.fromString("potion_water_breathing_long");
    public static final Identifier POTION_INSTANT_HEALTH = Identifier.fromString("potion_healing");
    public static final Identifier POTION_INSTANT_HEALTH_II = Identifier.fromString("potion_healing_2");
    public static final Identifier POTION_HARMING = Identifier.fromString("potion_harming");
    public static final Identifier POTION_HARMING_II = Identifier.fromString("potion_harming_2");
    public static final Identifier POTION_POISON = Identifier.fromString("potion_poison");
    public static final Identifier POTION_POISON_LONG = Identifier.fromString("potion_poison_long");
    public static final Identifier POTION_POISON_II = Identifier.fromString("potion_poison_2");
    public static final Identifier POTION_REGENERATION = Identifier.fromString("potion_regeneration");
    public static final Identifier POTION_REGENERATION_LONG = Identifier.fromString("potion_regeneration_long");
    public static final Identifier POTION_REGENERATION_II = Identifier.fromString("potion_regeneration_2");
    public static final Identifier POTION_STRENGTH = Identifier.fromString("potion_strength");
    public static final Identifier POTION_STRENGTH_LONG = Identifier.fromString("potion_strength_long");
    public static final Identifier POTION_STRENGTH_II = Identifier.fromString("potion_strength_2");
    public static final Identifier POTION_WEAKNESS = Identifier.fromString("potion_weakness");
    public static final Identifier POTION_WEAKNESS_LONG = Identifier.fromString("potion_weakness_long");
    public static final Identifier POTION_DECAY = Identifier.fromString("potion_decay");
    public static final Identifier POTION_TURTLE_MASTER = Identifier.fromString("potion_turtle_master");
    public static final Identifier POTION_TURTLE_MASTER_LONG = Identifier.fromString("potion_turtle_master_long");
    public static final Identifier POTION_TURTLE_MASTER_II = Identifier.fromString("potion_turtle_master_2");
    public static final Identifier POTION_SLOW_FALLING = Identifier.fromString("potion_slow_falling");
    public static final Identifier POTION_SLOW_FALLING_LONG = Identifier.fromString("potion_slow_falling_long");
}
