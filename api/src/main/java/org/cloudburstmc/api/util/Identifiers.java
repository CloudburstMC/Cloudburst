...
public class Identifiers {
    ...
    //Enchantments
    public static final Identifier AQUA_AFFINITY = Identifier.fromString("aqua_affinity");
    public static final Identifier BANE_OF_ARTHROPODS = Identifier.fromString("bane_of_arthropods");
    public static final Identifier BINDING = Identifier.fromString("binding");
    public static final Identifier BLAST_PROTECTION = Identifier.fromString("blast_protection");
    public static final Identifier CHANNELING = Identifier.fromString("channeling");
    public static final Identifier DEPTH_STRIDER = Identifier.fromString("depth_strider");
    public static final Identifier EFFICIENCY = Identifier.fromString("efficiency");
    public static final Identifier FEATHER_FALLING = Identifier.fromString("feather_falling");
    ...
    public static final Identifier FLAME = Identifier.fromString("flame");
    ...
    public static final Identifier IMPALING = Identifier.fromString("impaling");
    public static final Identifier INFINITY = Identifier.fromString("infinity");
    ...
    public static final Identifier LOYALTY = Identifier.fromString("loyalty");
    public static final Identifier LUCK_OF_THE_SEA = Identifier.fromString("luck_of_the_sea");
    ...
    public static final Identifier MULTISHOT = Identifier.fromString("multishot");
    public static final Identifier PIERCING = Identifier.fromString("piercing");
    public static final Identifier POWER = Identifier.fromString("power");
    ...
    public static final Identifier PUNCH = Identifier.fromString("punch");
    public static final Identifier QUICK_CHARGE = Identifier.fromString("quick_charge");
    public static final Identifier RESPIRATION = Identifier.fromString("respiration");
    public static final Identifier RIPTIDE = Identifier.fromString("riptide");
    public static final Identifier SHARPNESS = Identifier.fromString("sharpness");
    public static final Identifier SILK_TOUCH = Identifier.fromString("silk_touch");
    public static final Identifier SMITE = Identifier.fromString("smite");
    public static final Identifier SOUL_SPEED = Identifier.fromString("soul_speed");
    public static final Identifier THORNS = Identifier.fromString("thorns");
    public static final Identifier UNBREAKING = Identifier.fromString("unbreaking");
    public static final Identifier VANISHING = Identifier.fromString("vanishing");
    ...
    public static final Identifier INSTANT_DAMAGE = Identifier.fromString("instant_damage");
    public static final Identifier INSTANT_HEALTH = Identifier.fromString("instant_health");
    ...
    public static final Identifier RESISTANCE = Identifier.fromString("resistance");
    ...
    public static final Identifier VILLAGE_HERO = Identifier.fromString("village_hero");
    ...
    //Potions
    public static final Identifier POTION_AWKWARD = Identifier.fromString("awkward");
    public static final Identifier POTION_FiRE_RESISTANCE = Identifier.fromString("fire_resistance");
    public static final Identifier POTION_HARMING = Identifier.fromString("harming");
    public static final Identifier POTION_HEALING = Identifier.fromString("healing");
    public static final Identifier POTION_INVISIBILITY = Identifier.fromString("invisibility");
    public static final Identifier POTION_LEAPING = Identifier.fromString("leaping");
    public static final Identifier POTION_LONG_FIRE_RESISTANCE = Identifier.fromString("long_fire_resistance");
    public static final Identifier POTION_LONG_INVISIBILITY = Identifier.fromString("long_invisibility");
    public static final Identifier POTION_LONG_LEAPING = Identifier.fromString("long_leaping");
    public static final Identifier POTION_LONG_MUNDANE = Identifier.fromString("long_mundane");
    public static final Identifier POTION_LONG_NIGHT_VISION = Identifier.fromString("long_night_vision");
    public static final Identifier POTION_LONG_POISON = Identifier.fromString("long_poison");
    public static final Identifier POTION_LONG_REGENERATION = Identifier.fromString("long_regeneration");
    public static final Identifier POTION_LONG_SLOW_FALLING = Identifier.fromString("long_slow_falling");
    public static final Identifier POTION_LONG_SLOWNESS = Identifier.fromString("long_slowness");
    public static final Identifier POTION_LONG_STRENGTH = Identifier.fromString("long_strength");
    public static final Identifier POTION_LONG_SWIFTNESS = Identifier.fromString("long_swiftness");
    public static final Identifier POTION_LONG_TURTLE_MASTER = Identifier.fromString("long_turtle_master");
    public static final Identifier POTION_LONG_WATER_BREATHING = Identifier.fromString("long_water_breathing");
    public static final Identifier POTION_LONG_WEAKNESS = Identifier.fromString("long_weakness");
    public static final Identifier POTION_MUNDANE = Identifier.fromString("mundane");
    public static final Identifier POTION_NIGHT_VISION = Identifier.fromString("night_vision");
    public static final Identifier POTION_POISON = Identifier.fromString("poison");
    public static final Identifier POTION_REGENERATION = Identifier.fromString("regeneration");
    public static final Identifier POTION_SLOW_FALLING = Identifier.fromString("slow_falling");
    public static final Identifier POTION_SLOWNESS = Identifier.fromString("slowness");
    public static final Identifier POTION_STRENGTH = Identifier.fromString("strength");
    public static final Identifier POTION_STRONG_HARMING = Identifier.fromString("strong_harming");
    public static final Identifier POTION_STRONG_HEALING = Identifier.fromString("strong_healing");
    public static final Identifier POTION_STRONG_LEAPING = Identifier.fromString("strong_leaping");
    public static final Identifier POTION_STRONG_POISON = Identifier.fromString("strong_poison");
    public static final Identifier POTION_STRONG_REGENERATION = Identifier.fromString("strong_regeneration");
    public static final Identifier POTION_STRONG_SLOWNESS = Identifier.fromString("strong_slowness");
    public static final Identifier POTION_STRONG_STRENGTH = Identifier.fromString("strong_strength");
    public static final Identifier POTION_STRONG_SWIFTNESS = Identifier.fromString("strong_swiftness");
    public static final Identifier POTION_STRONG_TURTLE_MASTER = Identifier.fromString("strong_turtle_master");
    public static final Identifier POTION_SWIFTNESS = Identifier.fromString("swiftness");
    public static final Identifier POTION_THICK = Identifier.fromString("thick");
    public static final Identifier POTION_TURTLE_MASTER = Identifier.fromString("turtle_master");
    public static final Identifier POTION_WATER = Identifier.fromString("water");
    public static final Identifier POTION_WATER_BREATHING = Identifier.fromString("water_breathing");
    public static final Identifier POTION_WEAKNESS = Identifier.fromString("weakness");
    public static final Identifier POTION_WITHER = Identifier.fromString("wither");
}
