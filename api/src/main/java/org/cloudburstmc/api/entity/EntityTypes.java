...
public class EntityTypes {
    public static final EntityType<Agent> AGENT = EntityType.from("agent", Agent.class);
    public static final EntityType<Allay> ALLAY = EntityType.from("allay", Allay.class);
    public static final EntityType<AreaEffectCloud> AREA_EFFECT_CLOUD = EntityType.from("area_effect_cloud", AreaEffectCloud.class);
    public static final EntityType<Armadillo> ARMADILLO = EntityType.from("armadillo", Armadillo.class);
    ...
    public static final EntityType<Axolotl> AXOLOTL = EntityType.from("axolotl", Axolotl.class);
    public static final EntityType<Balloon> BALLOON = EntityType.from("balloon", Balloon.class);
    public static final EntityType<Bat> BAT = EntityType.from("bat", Bat.class);
    public static final EntityType<Bee> BEE = EntityType.from("bee", Bee.class);
    ...
    public static final EntityType<Bogged> BOGGED = EntityType.from("bogged", Bogged.class);
    public static final EntityType<Breeze> BREEZE = EntityType.from("breeze", Breeze.class);
    public static final EntityType<BreezeWindChargeProjectile> BREEZE_WIND_CHARGE_PROJECTILE = EntityType.from("breeze_wind_charge_projectile", BreezeWindChargeProjectile.class);
    public static final EntityType<Camel> CAMEL = EntityType.from("camel", Camel.class);
    public static final EntityType<CamelHusk> CAMEL_HUSK = EntityType.from("camel_husk", CamelHusk.class);
    ...
    public static final EntityType<ChestBoat> CHEST_BOAT = EntityType.from("chest_boat", ChestBoat.class);
    ...
    public static final EntityType<CopperGolem> COPPER_GOLEM = EntityType.from("copper_golem", CopperGolem.class);
    public static final EntityType<Cow> COW = EntityType.from("cow", Cow.class);
    public static final EntityType<Creaking> CREAKING = EntityType.from("creaking", Creaking.class);
    ...
    public static final EntityType<ElderGuardianGhost> ELDER_GUARDIAN_GHOST = EntityType.from("elder_guardian_ghost", ElderGuardianGhost.class);
    ...
    public static final EntityType<Fox> FOX = EntityType.from("fox", Fox.class);
    public static final EntityType<Frog> FROG = EntityType.from("frog", Frog.class);
    public static final EntityType<Ghast> GHAST = EntityType.from("ghast", Ghast.class);
    public static final EntityType<GlowSquid> GLOW_SQUID = EntityType.from("glow_squid", GlowSquid.class);
    public static final EntityType<Goat> GOAT = EntityType.from("goat", Goat.class);
    public static final EntityType<Guardian> GUARDIAN = EntityType.from("guardian", Guardian.class);
    public static final EntityType<HappyGhast> HAPPY_GHAST = EntityType.from("happy_ghast", HappyGhast.class);
    public static final EntityType<Hoglin> HOGLIN = EntityType.from("hoglin", Hoglin.class);
    ...
    public static final EntityType<IceBomb> ICE_BOMB = EntityType.from("ice_bomb", IceBomb.class);
    ...
    public static final EntityType<Nautilus> NAUTILUS = EntityType.from("nautilus", Nautilus.class);
    ...
    public static final EntityType<OminousItemSpawner> OMINOUS_ITEM_SPAWNER = EntityType.from("ominous_item_spawner", OminousItemSpawner.class);
    ...
    public static final EntityType<Parched> PARCHED = EntityType.from("parched", Parched.class);
    ...
    public static final EntityType<Piglin> PIGLIN = EntityType.from("piglin", Piglin.class);
    public static final EntityType<PiglinBrute> PIGLIN_BRUTE = EntityType.from("piglin_brute", PiglinBrute.class);
    ...
    public static final EntityType<Sniffer> SNIFFER = EntityType.from("sniffer", Sniffer.class);
    ...
    public static final EntityType<TraderLlama> TRADER_LLAMA = EntityType.from("trader_llama", TraderLlama.class);
    public static final EntityType<TripodCamera> TRIPOD_CAMERA = EntityType.from("tripod_camera", TripodCamera.class);
    public static final EntityType<TropicalFish> TROPICAL_FISH = EntityType.from("tropicalfish", TropicalFish.class);
    ...
    public static final EntityType<Warden> WARDEN = EntityType.from("warden", Warden.class);
    public static final EntityType<WindChargeProjectile> WIND_CHARGE_PROJECTILE = EntityType.from("wind_charge_projectile", WindChargeProjectile.class);
    ...
    public static final EntityType<Zoglin> ZOGLIN = EntityType.from("zoglin", Zoglin.class);
