...
public class EnchantmentTypes {
    private static final BuiltInTypeCatalog<EnchantmentType> TYPES = BuiltInTypeCatalog.create(EnchantmentType::identifier);
    ...
    /**
     * Finds a built-in enchantment type by identifier.
     *
     * @param id enchantment identifier
     * @return matching built-in enchantment type, if present
     */
    ...
    /**
     * Returns all built-in enchantment types in declaration order.
     *
     * @return built-in enchantment types
     */
    ...
    private static EnchantmentType type(Identifier identifier, int maxLevel, EnchantmentRarity rarity,
        ...
        return TYPES.register(new EnchantmentType(identifier, maxLevel, rarity, treasure, cursed, target, exclusiveGroup,
