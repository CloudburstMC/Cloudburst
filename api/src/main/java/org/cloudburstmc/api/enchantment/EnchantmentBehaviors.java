...
public final class EnchantmentBehaviors {
    ...
    public static final BehaviorKey<DamageBonusBehavior, DamageBonusBehavior.Executor> GET_DAMAGE_BONUS =
            DataKey.behavior(Identifier.parse("get_damage_bonus"), DamageBonusBehavior.class, DamageBonusBehavior.Executor.class);

    public static final BehaviorKey<DamageProtectionBehavior, DamageProtectionBehavior.Executor> GET_DAMAGE_PROTECTION =
            DataKey.behavior(Identifier.parse("get_damage_protection"), DamageProtectionBehavior.class, DamageProtectionBehavior.Executor.class);

    public static final BehaviorKey<PostHurtBehavior, PostHurtBehavior.Executor> DO_POST_HURT =
            DataKey.behavior(Identifier.parse("do_post_hurt"), PostHurtBehavior.class, PostHurtBehavior.Executor.class);

    public static final BehaviorKey<IntBehavior, IntBehavior.Executor> GET_MIN_LEVEL =
            DataKey.behavior(Identifier.parse("get_min_level"), IntBehavior.class, IntBehavior.Executor.class);

    public static final BehaviorKey<IntBehavior, IntBehavior.Executor> GET_MAX_LEVEL =
            DataKey.behavior(Identifier.parse("get_max_level"), IntBehavior.class, IntBehavior.Executor.class);

    public static final BehaviorKey<IntBehavior, IntBehavior.Executor> GET_MIN_COST =
            DataKey.behavior(Identifier.parse("get_min_cost"), IntBehavior.class, IntBehavior.Executor.class);

    public static final BehaviorKey<IntBehavior, IntBehavior.Executor> GET_MAX_COST =
            DataKey.behavior(Identifier.parse("get_max_cost"), IntBehavior.class, IntBehavior.Executor.class);

    public static final BehaviorKey<IntBehavior, IntBehavior.Executor> GET_FREQUENCY =
            DataKey.behavior(Identifier.parse("get_frequency"), IntBehavior.class, IntBehavior.Executor.class);
}
