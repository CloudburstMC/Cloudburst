 ...
 * This is a server-internal interface and is not part of the plugin API.
 * Plugins should interact with inventories through the higher-level view interfaces in
 * {@code org.cloudburstmc.api.inventory.view} (e.g. {@code StorageView}, {@code FurnaceView})
 * obtained from an {@link org.cloudburstmc.api.inventory.InventoryScreen}.
 */
