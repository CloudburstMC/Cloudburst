...
@Log4j2
@Singleton
public class CloudConsoleCommandSender implements CommandSender {

    private final CloudPermissible perm;

    @Inject
    public CloudConsoleCommandSender(PermissionManager permissionManager) {
        this.perm = new CloudPermissible(permissionManager, this, () -> {});
    }
