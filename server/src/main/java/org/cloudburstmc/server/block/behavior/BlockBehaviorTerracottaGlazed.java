 ...
 */
public class BlockBehaviorTerracottaGlazed extends BlockBehaviorSolid implements Faceable {
    ...
    public Item[] getDrops(Item hand) {
        return hand.getTier() >= ItemTool.TIER_WOODEN ? new Item[]{this.toItem()} : new Item[0];
    }
