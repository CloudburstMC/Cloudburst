...
public class BlockTypes {
    ...
    public static final BlockType BEDROCK = IntBlock.builder().id(BlockIds.BEDROCK).maxStackSize(64).hardness(-1).pushesOutItems(true).resistance(1.8E7f).solid(true).resistance(1.8E7f).targetTool(ToolTypes.PICKAXE).resistance(1.8E7f).canBeSilkTouched(true).breakFlowing(true).resistance(1.8E7f).build();
    ...
    public static final BlockType TORCH = IntBlock.builder().id(BlockIds.TORCH).maxStackSize(64).diggable(true).emitLight(14).floodable(true).translucency(1).filterLight(0).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).build();
    ...
    public static final BlockType COMMAND_BLOCK = IntBlock.builder().id(BlockIds.COMMAND_BLOCK).maxStackSize(64).hardness(-1).pushesOutItems(true).resistance(1.8E7f).solid(true).resistance(1.8E7f).targetTool(ToolTypes.PICKAXE).resistance(1.8E7f).comparatorSignal(true).breakFlowing(true).resistance(1.8E7f).build();
    ...
    public static final BlockType BARRIER = IntBlock.builder().id(BlockIds.BARRIER).maxStackSize(64).hardness(-1).pushesOutItems(true).resistance(1.8E7f).solid(true).translucency(1).resistance(1.8E7f).resistance(1.8E7f).filterLight(0).canBeSilkTouched(true).breakFlowing(true).waterlogSource(true).resistance(1.8E7f).build();
    ...
    public static final BlockType NETHER_ROOTS = IntBlock.builder().id(BlockIds.CRIMSON_ROOTS).maxStackSize(64).diggable(true).burnAbility(100).burnChance(60).translucency(1).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockWater(false).canBeSilkTouched(true).blockSolid(false).blockMotion(false).build();
    public static final BlockType NETHER_FUNGUS = IntBlock.builder().id(BlockIds.CRIMSON_FUNGUS).maxStackSize(64).diggable(true).translucency(1).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockWater(false).canBeSilkTouched(true).blockSolid(false).blockMotion(false).build();
    ...
    public static final BlockType WITHER_ROSE = IntBlock.builder().id(BlockIds.WITHER_ROSE).maxStackSize(64).diggable(true).translucency(1).burnChance(60).burnAbility(100).filterLight(0).breakFalling(true).blockWater(false).canBeSilkTouched(true).blockSolid(false).blockMotion(false).targetTool(ToolTypes.AXE).build();
