...
public class BlockTypes {
    ...
    public static final BlockType PLANKS = IntBlock.builder().id(BlockIds.PLANKS).maxStackSize(64).diggable(true).hardness(2).fuelTime((short) 300).burnAbility(20).burnChance(5).flammable(true).pushesOutItems(true).resistance(15).solid(true).targetTool(ToolTypes.AXE).canBeSilkTouched(true).breakFlowing(true).build();
    public static final BlockType SAPLING = IntBlock.builder().id(BlockIds.SAPLING).maxStackSize(64).diggable(true).floodable(true).fuelTime((short) 100).translucency(1).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockWater(false).canBeSilkTouched(true).blockSolid(false).blockMotion(false).build();
    public static final BlockType BEDROCK = IntBlock.builder().id(BlockIds.BEDROCK).maxStackSize(64).hardness(-1).pushesOutItems(true).resistance(1.8E7f).solid(true).resistance(1.8E7f).targetTool(ToolTypes.PICKAXE).resistance(1.8E7f).canBeSilkTouched(true).breakFlowing(true).resistance(1.8E7f).resistance(1.8E7f).build();
    ...
    public static final BlockType NOTEBLOCK = IntBlock.builder().id(BlockIds.NOTEBLOCK).maxStackSize(64).diggable(true).hardness(0.8f).fuelTime((short) 300).flammable(true).pushesOutItems(true).resistance(4).solid(true).targetTool(ToolTypes.AXE).breakFlowing(true).build();
    public static final BlockType BED = IntBlock.builder().id(BlockIds.BED).maxStackSize(1).diggable(true).hardness(0.2f).floodable(true).resistance(1).translucency(0.1f).filterLight(0).breakFalling(true).blockSolid(false).blockMotion(false).breakFlowing(true).waterlogSource(true).aabb(new SimpleAxisAlignedBB(0, 0, 0, 1, 0.5625f, 1)).build();
    public static final BlockType GOLDEN_RAIL = IntBlock.builder().id(BlockIds.GOLDEN_RAIL).maxStackSize(64).diggable(true).hardness(0.7f).floodable(true).resistance(3.5f).translucency(1).filterLight(0).breakFalling(true).blockWater(false).canBeSilkTouched(true).blockSolid(false).blockMotion(false).waterlogSource(true).aabb(new SimpleAxisAlignedBB(0, 0, 0, 1, 0.125f, 1)).build();
    public static final BlockType DETECTOR_RAIL = IntBlock.builder().id(BlockIds.DETECTOR_RAIL).maxStackSize(64).diggable(true).hardness(0.7f).floodable(true).resistance(3.5f).translucency(1).filterLight(0).powerSource(true).breakFalling(true).blockWater(false).canBeSilkTouched(true).blockSolid(false).blockMotion(false).comparatorSignal(true).waterlogSource(true).aabb(new SimpleAxisAlignedBB(0, 0, 0, 1, 0.125f, 1)).build();
    ...
    public static final BlockType ELEMENT = IntBlock.builder().id(BlockIds.ELEMENT_0).maxStackSize(64).diggable(true).pushesOutItems(true).solid(true).canBeSilkTouched(true).breakFlowing(true).build();
    public static final BlockType FLOWER = IntBlock.builder().id(BlockIds.RED_FLOWER).maxStackSize(64).diggable(true).floodable(true).burnAbility(100).burnChance(60).translucency(1).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockWater(false).canBeSilkTouched(true).blockSolid(false).blockMotion(false).aabb(new SimpleAxisAlignedBB(0.3f, 0, 0.3f, 0.7f, 0.6f, 0.7f)).build();
    public static final BlockType BROWN_MUSHROOM = IntBlock.builder().id(BlockIds.BROWN_MUSHROOM).maxStackSize(64).diggable(true).emitLight(1).translucency(1).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockWater(false).canBeSilkTouched(true).blockSolid(false).blockMotion(false).aabb(new SimpleAxisAlignedBB(0.3f, 0, 0.3f, 0.7f, 0.4f, 0.7f)).build();
    public static final BlockType RED_MUSHROOM = IntBlock.builder().id(BlockIds.RED_MUSHROOM).maxStackSize(64).diggable(true).floodable(true).translucency(1).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockWater(false).canBeSilkTouched(true).blockSolid(false).blockMotion(false).aabb(new SimpleAxisAlignedBB(0.3f, 0, 0.3f, 0.7f, 0.4f, 0.7f)).build();
    ...
    public static final BlockType BOOKSHELF = IntBlock.builder().id(BlockIds.BOOKSHELF).maxStackSize(64).diggable(true).hardness(1.5f).fuelTime((short) 300).burnAbility(20).burnChance(30).flammable(true).pushesOutItems(true).resistance(7.5f).solid(true).targetTool(ToolTypes.AXE).canBeSilkTouched(true).breakFlowing(true).build();
    ...
    public static final BlockType TORCH = IntBlock.builder().id(BlockIds.TORCH).maxStackSize(64).diggable(true).emitLight(14).floodable(true).translucency(1).filterLight(0).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).aabb(new SimpleAxisAlignedBB(0, 0.2f, 0.35f, 0.3f, 0.8f, 0.65f)).build();
    public static final BlockType FIRE = IntBlock.builder().id(BlockIds.FIRE).maxStackSize(0).diggable(true).emitLight(15).floodable(true).replaceable(true).translucency(1).filterLight(0).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).build();
    public static final BlockType MOB_SPAWNER = IntBlock.builder().id(BlockIds.MOB_SPAWNER).maxStackSize(64).diggable(true).transparent(true).hardness(5).emitLight(3).pushesOutItems(true).resistance(25).solid(true).targetTool(ToolTypes.PICKAXE).filterLight(0).breakFlowing(true).waterlogSource(true).aabb(new SimpleAxisAlignedBB(0.0001f, 0.0001f, 0.0001f, 0.9999f, 0.9999f, 0.9999f)).build();
    public static final BlockType WOODEN_STAIRS = IntBlock.builder().id(BlockIds.OAK_STAIRS).maxStackSize(64).diggable(true).hardness(2).fuelTime((short) 300).burnAbility(20).burnChance(5).flammable(true).pushesOutItems(true).resistance(15).translucency(0.8f).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockSolid(false).blockMotion(false).breakFlowing(true).waterlogSource(true).build();
    public static final BlockType CHEST = IntBlock.builder().id(BlockIds.CHEST).maxStackSize(64).diggable(true).hardness(2.5f).fuelTime((short) 300).flammable(true).pushesOutItems(true).resistance(12.5f).translucency(0.5f).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockSolid(false).blockMotion(false).comparatorSignal(true).breakFlowing(true).waterlogSource(true).build();
    public static final BlockType REDSTONE_WIRE = IntBlock.builder().id(BlockIds.REDSTONE_WIRE).maxStackSize(64).diggable(true).translucency(0.8f).filterLight(0).breakFalling(true).blockWater(false).canBeSilkTouched(true).blockSolid(false).blockMotion(false).aabb(new SimpleAxisAlignedBB(0, 0, 0, 1, 0.0625f, 1)).build();
    ...
    public static final BlockType CRAFTING_TABLE = IntBlock.builder().id(BlockIds.CRAFTING_TABLE).maxStackSize(64).diggable(true).hardness(2.5f).fuelTime((short) 300).flammable(true).pushesOutItems(true).resistance(12.5f).solid(true).targetTool(ToolTypes.AXE).canBeSilkTouched(true).breakFlowing(true).build();
    public static final BlockType WHEAT = IntBlock.builder().id(BlockIds.WHEAT).maxStackSize(0).diggable(true).floodable(true).translucency(1).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).aabb(new SimpleAxisAlignedBB(0, 0, 0, 1, 0.25f, 1)).build();
    public static final BlockType FARMLAND = IntBlock.builder().id(BlockIds.FARMLAND).maxStackSize(64).diggable(true).transparent(true).hardness(0.6f).resistance(3).filterLight(0).breakFalling(true).breakFlowing(true).aabb(new SimpleAxisAlignedBB(0, 0, 0, 1, 0.9375f, 1)).build();
    public static final BlockType FURNACE = IntBlock.builder().id(BlockIds.FURNACE).maxStackSize(64).diggable(true).transparent(true).hardness(3.5f).pushesOutItems(true).resistance(17.5f).solid(true).targetTool(ToolTypes.PICKAXE).comparatorSignal(true).breakFlowing(true).build();
    //    public static final BlockType LIT_FURNACE = IntBlock.builder().id(BlockIds.LIT_FURNACE).maxStackSize(64).diggable(true).transparent(true).emitLight(13).hardness(3.5f).pushesOutItems(true).resistance(17.5f).solid(true).targetTool(ToolTypes.PICKAXE).comparatorSignal(true).waterlogFlowing(true).breakFlowing(true).build();
    public static final BlockType STANDING_SIGN = IntBlock.builder().id(BlockIds.OAK_STANDING_SIGN).maxStackSize(16).diggable(true).transparent(true).hardness(1).resistance(5).translucency(0.8f).filterLight(0).flammable(true).breakFalling(true).blockSolid(false).blockMotion(false).breakFlowing(true).waterlogSource(true).aabb(new SimpleAxisAlignedBB(0.25f, 0, 0.25f, 0.75f, 1, 0.75f)).build();
    public static final BlockType WOODEN_DOOR = IntBlock.builder().id(BlockIds.OAK_DOOR).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(3f).flammable(true).fuelTime((short) 200).build();
    public static final BlockType LADDER = IntBlock.builder().id(BlockIds.LADDER).maxStackSize(64).diggable(true).hardness(0.4f).fuelTime((short) 300).resistance(2).translucency(1).filterLight(0).breakFalling(true).blockSolid(false).blockMotion(false).breakFlowing(true).waterlogSource(true).build();
    public static final BlockType RAIL = IntBlock.builder().id(BlockIds.RAIL).maxStackSize(64).diggable(true).hardness(0.7f).floodable(true).resistance(3.5f).translucency(1).filterLight(0).breakFalling(true).blockWater(false).canBeSilkTouched(true).blockSolid(false).blockMotion(false).waterlogSource(true).aabb(new SimpleAxisAlignedBB(0, 0, 0, 1, 0.125f, 1)).build();
    ...
    public static final BlockType WALL_SIGN = IntBlock.builder().id(BlockIds.OAK_WALL_SIGN).maxStackSize(16).diggable(true).transparent(true).hardness(1).resistance(5).translucency(0.8f).filterLight(0).flammable(true).breakFalling(true).blockSolid(false).blockMotion(false).breakFlowing(true).waterlogSource(true).aabb(new SimpleAxisAlignedBB(0.25f, 0, 0.25f, 0.75f, 1, 0.75f)).build();
    ...
    public static final BlockType WOODEN_PRESSURE_PLATE = IntBlock.builder().id(BlockIds.OAK_PRESSURE_PLATE).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.5f).fuelTime((short) 300).build();
    public static final BlockType REDSTONE_ORE = IntBlock.builder().id(BlockIds.REDSTONE_ORE).maxStackSize(64).diggable(true).transparent(true).hardness(3).pushesOutItems(true).resistance(15).solid(true).targetTool(ToolTypes.PICKAXE).toolTier(TierTypes.IRON).canBeSilkTouched(true).breakFlowing(true).build();
    public static final BlockType REDSTONE_TORCH = IntBlock.builder().id(BlockIds.REDSTONE_TORCH).maxStackSize(64).diggable(true).emitLight(7).floodable(true).translucency(1).filterLight(0).powerSource(true).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).aabb(new SimpleAxisAlignedBB(0, 0.2f, 0.35f, 0.3f, 0.8f, 0.65f)).build();
    ...
    public static final BlockType SNOW_LAYER = IntBlock.builder().id(BlockIds.SNOW_LAYER).maxStackSize(64).diggable(true).hardness(0.1f).floodable(true).fallable(true).replaceable(true).resistance(0.5f).translucency(0.89f).filterLight(0).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).aabb(new SimpleAxisAlignedBB(0, 0, 0, 1, 0.125f, 1)).build();
    ...
    public static final BlockType REEDS = IntBlock.builder().id(BlockIds.REEDS).maxStackSize(64).diggable(true).floodable(true).translucency(1).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).aabb(new SimpleAxisAlignedBB(0.125f, 0, 0.125f, 0.875f, 1, 0.875f)).build();
    public static final BlockType JUKEBOX = IntBlock.builder().id(BlockIds.JUKEBOX).maxStackSize(64).diggable(true).hardness(0.8f).fuelTime((short) 300).flammable(true).pushesOutItems(true).resistance(4).solid(true).targetTool(ToolTypes.AXE).powerSource(true).comparatorSignal(true).breakFlowing(true).build();
    public static final BlockType WOODEN_FENCE = IntBlock.builder().id(BlockIds.FENCE).maxStackSize(64).diggable(true).hardness(2).fuelTime((short) 300).burnAbility(20).burnChance(5).flammable(true).resistance(15).translucency(0.8f).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockSolid(false).blockMotion(false).breakFlowing(true).waterlogSource(true).build();
    ...
    public static final BlockType REPEATER = IntBlock.builder().id(BlockIds.UNPOWERED_REPEATER).maxStackSize(64).diggable(true).translucency(1).filterLight(0).powerSource(true).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).breakFlowing(true).waterlogSource(true).aabb(new SimpleAxisAlignedBB(0, 0, 0, 1, 0.125f, 1)).build();
    public static final BlockType INVISIBLE_BEDROCK = IntBlock.builder().id(BlockIds.INVISIBLE_BEDROCK).maxStackSize(64).hardness(-1).resistance(1.8E7f).resistance(1.8E7f).translucency(0.8f).targetTool(ToolTypes.PICKAXE).resistance(1.8E7f).filterLight(0).breakFalling(true).canBeSilkTouched(true).breakFlowing(true).resistance(1.8E7f).resistance(1.8E7f).build();
    public static final BlockType WOODEN_TRAPDOOR = IntBlock.builder().id(BlockIds.OAK_TRAPDOOR).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(3f).fuelTime((short) 300).build();
    ...
    public static final BlockType BROWN_MUSHROOM_BLOCK = IntBlock.builder().id(BlockIds.BROWN_MUSHROOM_BLOCK).maxStackSize(64).diggable(true).hardness(0.2f).fuelTime((short) 300).flammable(true).pushesOutItems(true).resistance(1).solid(true).targetTool(ToolTypes.AXE).canBeSilkTouched(true).breakFlowing(true).build();
    public static final BlockType RED_MUSHROOM_BLOCK = IntBlock.builder().id(BlockIds.RED_MUSHROOM_BLOCK).maxStackSize(64).diggable(true).hardness(0.2f).fuelTime((short) 300).flammable(true).pushesOutItems(true).resistance(1).solid(true).targetTool(ToolTypes.AXE).canBeSilkTouched(true).breakFlowing(true).build();
    ...
    public static final BlockType PUMPKIN_STEM = IntBlock.builder().id(BlockIds.PUMPKIN_STEM).maxStackSize(64).diggable(true).floodable(true).translucency(1).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).aabb(new SimpleAxisAlignedBB(0.375f, 0, 0.375f, 0.625f, 0.25f, 0.625f)).build();
    public static final BlockType MELON_STEM = IntBlock.builder().id(BlockIds.MELON_STEM).maxStackSize(64).diggable(true).floodable(true).translucency(1).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).aabb(new SimpleAxisAlignedBB(0.375f, 0, 0.375f, 0.625f, 0.25f, 0.625f)).build();
    ...
    public static final BlockType WOODEN_FENCE_GATE = IntBlock.builder().id(BlockIds.OAK_FENCE_GATE).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(2f).fuelTime((short) 300).build();
    ...
    public static final BlockType WATERLILY = IntBlock.builder().id(BlockIds.WATERLILY).maxStackSize(64).diggable(true).floodable(true).translucency(1).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockWater(false).canBeSilkTouched(true).blockSolid(false).blockMotion(false).aabb(new SimpleAxisAlignedBB(0, 0, 0, 1, 0.015625f, 1)).build();
    public static final BlockType NETHER_BRICK = IntBlock.builder().id(BlockIds.NETHER_BRICK).maxStackSize(64).diggable(true).hardness(2).pushesOutItems(true).resistance(30).solid(true).targetTool(ToolTypes.PICKAXE).canBeSilkTouched(true).breakFlowing(true).build();
    ...
    public static final BlockType NETHER_WART = IntBlock.builder().id(BlockIds.NETHER_WART).maxStackSize(64).diggable(true).floodable(true).translucency(1).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).aabb(new SimpleAxisAlignedBB(0, 0, 0, 1, 0.25f, 1)).build();
    ...
    public static final BlockType CAULDRON = IntBlock.builder().id(BlockIds.CAULDRON).maxStackSize(64).diggable(true).hardness(2).filterLight(3).resistance(10).translucency(0.8f).targetTool(ToolTypes.PICKAXE).breakFalling(true).blockSolid(false).blockMotion(false).comparatorSignal(true).breakFlowing(true).build();
    public static final BlockType END_PORTAL = IntBlock.builder().id(BlockIds.END_PORTAL).maxStackSize(64).transparent(true).emitLight(15).hardness(-1).pushesOutItems(true).resistance(1.8E7f).resistance(1.8E7f).resistance(1.8E7f).filterLight(0).breakFalling(true).blockSolid(false).blockMotion(false).breakFlowing(true).resistance(1.8E7f).resistance(1.8E7f).build();
    public static final BlockType END_PORTAL_FRAME = IntBlock.builder().id(BlockIds.END_PORTAL_FRAME).maxStackSize(64).hardness(-1).pushesOutItems(true).resistance(1.8E7f).resistance(1.8E7f).translucency(0.8f).targetTool(ToolTypes.PICKAXE).resistance(1.8E7f).filterLight(0).breakFalling(true).canBeSilkTouched(true).blockSolid(false).blockMotion(false).comparatorSignal(true).breakFlowing(true).waterlogSource(true).resistance(1.8E7f).resistance(1.8E7f).aabb(new SimpleAxisAlignedBB(0, 0, 0, 1, 0.8125f, 1)).build();
    ...
    //    public static final BlockType LIT_REDSTONE_LAMP = IntBlock.builder().id(BlockIds.LIT_REDSTONE_LAMP).maxStackSize(64).diggable(true).emitLight(15).hardness(0.3f).pushesOutItems(true).resistance(1.5f).solid(true).translucency(1).canBeSilkTouched(true).waterlogFlowing(true).breakFlowing(true).build();
    ...
    public static final BlockType TRIPWIRE = IntBlock.builder().id(BlockIds.TRIPWIRE).maxStackSize(64).diggable(true).floodable(true).translucency(1).filterLight(0).breakFalling(true).blockWater(false).canBeSilkTouched(true).blockSolid(false).blockMotion(false).breakFlowing(true).waterlogSource(true).aabb(new SimpleAxisAlignedBB(0, 0, 0, 1, 0.15625f, 1)).build();
    ...
    public static final BlockType COMMAND_BLOCK = IntBlock.builder().id(BlockIds.COMMAND_BLOCK).maxStackSize(64).hardness(-1).pushesOutItems(true).resistance(1.8E7f).solid(true).resistance(1.8E7f).targetTool(ToolTypes.PICKAXE).resistance(1.8E7f).comparatorSignal(true).breakFlowing(true).resistance(1.8E7f).resistance(1.8E7f).build();
    ...
    public static final BlockType STONE_WALL = IntBlock.builder().id(BlockIds.COBBLESTONE_WALL).maxStackSize(64).diggable(true).hardness(2).resistance(30).translucency(0.8f).targetTool(ToolTypes.PICKAXE).filterLight(0).breakFalling(true).blockSolid(false).blockMotion(false).breakFlowing(true).waterlogSource(true).build();
    public static final BlockType FLOWER_POT = IntBlock.builder().id(BlockIds.FLOWER_POT).maxStackSize(64).diggable(true).floodable(true).translucency(1).filterLight(0).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).waterlogSource(true).aabb(new SimpleAxisAlignedBB(0.3125f, 0, 0.3125f, 0.6875f, 0.375f, 0.6875f)).build();
    public static final BlockType CARROTS = IntBlock.builder().id(BlockIds.CARROTS).maxStackSize(64).diggable(true).floodable(true).translucency(1).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).aabb(new SimpleAxisAlignedBB(0, 0, 0, 1, 0.25f, 1)).build();
    public static final BlockType POTATOES = IntBlock.builder().id(BlockIds.POTATOES).maxStackSize(64).diggable(true).floodable(true).translucency(1).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).aabb(new SimpleAxisAlignedBB(0, 0, 0, 1, 0.25f, 1)).build();
    public static final BlockType WOODEN_BUTTON = IntBlock.builder().id(BlockIds.OAK_BUTTON).maxStackSize(64).diggable(true).transparent(true).solid(true).hardness(0.5f).floodable(true).fuelTime((short) 100).build();
    public static final BlockType SKULL = IntBlock.builder().id(BlockIds.SKULL).maxStackSize(64).diggable(true).hardness(1).floodable(true).resistance(5).translucency(1).filterLight(0).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).waterlogSource(true).aabb(new SimpleAxisAlignedBB(0.25f, 0, 0.25f, 0.75f, 0.5f, 0.75f)).build();
    ...
    public static final BlockType TRAPPED_CHEST = IntBlock.builder().id(BlockIds.TRAPPED_CHEST).maxStackSize(64).diggable(true).hardness(2.5f).fuelTime((short) 300).flammable(true).pushesOutItems(true).resistance(12.5f).translucency(0.5f).targetTool(ToolTypes.AXE).filterLight(0).powerSource(true).breakFalling(true).blockSolid(false).blockMotion(false).comparatorSignal(true).breakFlowing(true).waterlogSource(true).build();
    ...
    public static final BlockType COMPARATOR = IntBlock.builder().id(BlockIds.UNPOWERED_COMPARATOR).maxStackSize(64).diggable(true).translucency(1).filterLight(0).powerSource(true).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).breakFlowing(true).waterlogSource(true).aabb(new SimpleAxisAlignedBB(0, 0, 0, 1, 0.125f, 1)).build();
    public static final BlockType DAYLIGHT_DETECTOR = IntBlock.builder().id(BlockIds.DAYLIGHT_DETECTOR).maxStackSize(64).diggable(true).transparent(true).hardness(0.2f).fuelTime((short) 300).flammable(true).pushesOutItems(true).resistance(1).targetTool(ToolTypes.AXE).filterLight(0).powerSource(true).breakFalling(true).blockSolid(false).blockMotion(false).breakFlowing(true).waterlogSource(true).build();
    ...
    public static final BlockType QUARTZ_BLOCK = IntBlock.builder().id(BlockIds.QUARTZ_BLOCK).maxStackSize(64).diggable(true).hardness(0.8f).pushesOutItems(true).resistance(4).solid(true).targetTool(ToolTypes.PICKAXE).canBeSilkTouched(true).breakFlowing(true).build();
    public static final BlockType WOODEN_SLAB = IntBlock.builder().id(BlockIds.WOODEN_SLAB).maxStackSize(64).diggable(true).transparent(true).hardness(2).fuelTime((short) 300).burnAbility(20).burnChance(5).flammable(true).pushesOutItems(true).resistance(15).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockSolid(false).blockMotion(false).breakFlowing(true).waterlogSource(true).build();
    ...
    public static final BlockType COAL_BLOCK = IntBlock.builder().id(BlockIds.COAL_BLOCK).maxStackSize(64).diggable(true).hardness(5).fuelTime((short) 16000).burnAbility(5).burnChance(5).pushesOutItems(true).resistance(30).solid(true).targetTool(ToolTypes.PICKAXE).canBeSilkTouched(true).breakFlowing(true).build();
    ...
    public static final BlockType DAYLIGHT_DETECTOR_INVERTED = IntBlock.builder().id(BlockIds.DAYLIGHT_DETECTOR_INVERTED).maxStackSize(64).diggable(true).transparent(true).hardness(0.2f).fuelTime((short) 300).flammable(true).pushesOutItems(true).resistance(1).targetTool(ToolTypes.AXE).filterLight(0).powerSource(true).breakFalling(true).blockSolid(false).blockMotion(false).breakFlowing(true).waterlogSource(true).build();
    ...
    public static final BlockType REPEATING_COMMAND_BLOCK = IntBlock.builder().id(BlockIds.REPEATING_COMMAND_BLOCK).maxStackSize(64).hardness(-1).pushesOutItems(true).resistance(1.8E7f).solid(true).resistance(1.8E7f).targetTool(ToolTypes.PICKAXE).resistance(1.8E7f).comparatorSignal(true).breakFlowing(true).resistance(1.8E7f).resistance(1.8E7f).build();
    public static final BlockType CHAIN_COMMAND_BLOCK = IntBlock.builder().id(BlockIds.CHAIN_COMMAND_BLOCK).maxStackSize(64).hardness(-1).pushesOutItems(true).resistance(1.8E7f).solid(true).resistance(1.8E7f).targetTool(ToolTypes.PICKAXE).resistance(1.8E7f).comparatorSignal(true).breakFlowing(true).resistance(1.8E7f).resistance(1.8E7f).build();
    ...
    public static final BlockType GRASS_PATH = IntBlock.builder().id(BlockIds.GRASS_PATH).maxStackSize(64).diggable(true).transparent(true).hardness(0.65f).resistance(3.25f).filterLight(0).breakFalling(true).canBeSilkTouched(true).breakFlowing(true).aabb(new SimpleAxisAlignedBB(0, 0, 0, 1, 0.9375f, 1)).build();
    ...
    public static final BlockType COLORED_TORCH_RG = IntBlock.builder().id(BlockIds.COLORED_TORCH_RG).maxStackSize(64).diggable(true).emitLight(14).translucency(1).filterLight(0).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).aabb(new SimpleAxisAlignedBB(0, 0.2f, 0.35f, 0.3f, 0.8f, 0.65f)).build();
    public static final BlockType COLORED_TORCH_BP = IntBlock.builder().id(BlockIds.COLORED_TORCH_BP).maxStackSize(64).diggable(true).emitLight(14).translucency(1).filterLight(0).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).aabb(new SimpleAxisAlignedBB(0, 0.2f, 0.35f, 0.3f, 0.8f, 0.65f)).build();
    ...
    public static final BlockType END_ROD = IntBlock.builder().id(BlockIds.END_ROD).maxStackSize(64).diggable(true).emitLight(14).floodable(true).translucency(1).filterLight(0).blockWater(false).canBeSilkTouched(true).blockSolid(false).blockMotion(false).breakFlowing(true).waterlogSource(true).aabb(new SimpleAxisAlignedBB(0.3f, 0, 0.3f, 0.7f, 0.6f, 0.7f)).build();
    public static final BlockType END_GATEWAY = IntBlock.builder().id(BlockIds.END_GATEWAY).maxStackSize(64).emitLight(15).hardness(-1).pushesOutItems(true).resistance(1.8E7f).resistance(1.8E7f).resistance(1.8E7f).filterLight(0).breakFalling(true).blockSolid(false).blockMotion(false).breakFlowing(true).resistance(1.8E7f).resistance(1.8E7f).build();
    ...
    public static final BlockType NETHER_WART_BLOCK = IntBlock.builder().id(BlockIds.NETHER_WART_BLOCK).maxStackSize(64).diggable(true).hardness(1).pushesOutItems(true).resistance(5).solid(true).canBeSilkTouched(true).breakFlowing(true).build();
    ...
    public static final BlockType GLAZED_TERRACOTTA = IntBlock.builder().id(BlockIds.WHITE_GLAZED_TERRACOTTA).maxStackSize(64).diggable(true).hardness(1.4f).pushesOutItems(true).resistance(7).solid(true).targetTool(ToolTypes.PICKAXE).canBeSilkTouched(true).breakFlowing(true).build();
    ...
    public static final BlockType UNDERWATER_TORCH = IntBlock.builder().id(BlockIds.UNDERWATER_TORCH).maxStackSize(64).diggable(true).emitLight(14).translucency(1).filterLight(0).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).waterlogSource(true).aabb(new SimpleAxisAlignedBB(0, 0.2f, 0.35f, 0.3f, 0.8f, 0.65f)).build();
    ...
    public static final BlockType BEETROOT = IntBlock.builder().id(BlockIds.BEETROOT).maxStackSize(64).diggable(true).translucency(1).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).aabb(new SimpleAxisAlignedBB(0, 0, 0, 1, 0.25f, 1)).build();
    ...
    public static final BlockType STRUCTURE_BLOCK = IntBlock.builder().id(BlockIds.STRUCTURE_BLOCK).maxStackSize(64).hardness(-1).pushesOutItems(true).resistance(1.8E7f).solid(true).resistance(1.8E7f).targetTool(ToolTypes.PICKAXE).resistance(1.8E7f).blockSolid(false).blockMotion(false).breakFlowing(true).waterlogSource(true).resistance(1.8E7f).resistance(1.8E7f).build();
    ...
    public static final BlockType SEAGRASS = IntBlock.builder().id(BlockIds.SEAGRASS).maxStackSize(64).diggable(true).flammable(true).replaceable(true).translucency(1).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).waterlogSource(true).aabb(new SimpleAxisAlignedBB(0.1f, 0, 0.1f, 0.9f, 0.8f, 0.9f)).build();
    public static final BlockType CORAL = IntBlock.builder().id(BlockIds.CORAL).maxStackSize(64).diggable(true).translucency(0.8f).filterLight(0).breakFalling(true).blockWater(false).canBeSilkTouched(true).blockSolid(false).blockMotion(false).waterlogSource(true).aabb(new SimpleAxisAlignedBB(0.1f, 0, 0.1f, 0.9f, 0.8f, 0.9f)).build();
    ...
    public static final BlockType CORAL_FAN = IntBlock.builder().id(BlockIds.CORAL_FAN).maxStackSize(64).diggable(true).resistance(4.5f).translucency(0.8f).filterLight(0).breakFalling(true).blockWater(false).canBeSilkTouched(true).blockSolid(false).blockMotion(false).waterlogSource(true).aabb(new SimpleAxisAlignedBB(0.2f, 0, 0.2f, 0.8f, 0.4f, 0.8f)).build();
    public static final BlockType CORAL_FAN_DEAD = IntBlock.builder().id(BlockIds.CORAL_FAN_DEAD).maxStackSize(64).diggable(true).resistance(4.5f).translucency(0.8f).filterLight(0).breakFalling(true).blockWater(false).canBeSilkTouched(true).blockSolid(false).blockMotion(false).waterlogSource(true).aabb(new SimpleAxisAlignedBB(0.2f, 0, 0.2f, 0.8f, 0.4f, 0.8f)).build();
    public static final BlockType CORAL_FAN_HANG = IntBlock.builder().id(BlockIds.CORAL_FAN_HANG).maxStackSize(64).diggable(true).resistance(4.5f).translucency(0.8f).filterLight(0).breakFalling(true).blockWater(false).canBeSilkTouched(true).blockSolid(false).blockMotion(false).waterlogSource(true).aabb(new SimpleAxisAlignedBB(0.2f, 0.3f, 0.2f, 0.8f, 0.7f, 0.8f)).build();
    public static final BlockType KELP = IntBlock.builder().id(BlockIds.KELP).maxStackSize(64).diggable(true).translucency(1).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).waterlogSource(true).aabb(new SimpleAxisAlignedBB(0.125f, 0, 0.125f, 0.875f, 1, 0.875f)).build();
    public static final BlockType DRIED_KELP_BLOCK = IntBlock.builder().id(BlockIds.DRIED_KELP_BLOCK).maxStackSize(64).diggable(true).hardness(0.5f).fuelTime((short) 4000).burnAbility(5).burnChance(30).pushesOutItems(true).resistance(2.5f).solid(true).canBeSilkTouched(true).breakFlowing(true).build();
    ...
    public static final BlockType TURTLE_EGG = IntBlock.builder().id(BlockIds.TURTLE_EGG).maxStackSize(64).diggable(true).transparent(true).hardness(0.4f).resistance(2).filterLight(0).breakFalling(true).canBeSilkTouched(true).blockSolid(false).blockMotion(false).breakFlowing(true).waterlogSource(true).aabb(new SimpleAxisAlignedBB(0.2f, 0, 0.2f, 0.8f, 0.45f, 0.8f)).build();
    ...
    public static final BlockType BARRIER = IntBlock.builder().id(BlockIds.BARRIER).maxStackSize(64).hardness(-1).pushesOutItems(true).resistance(1.8E7f).solid(true).translucency(1).resistance(1.8E7f).resistance(1.8E7f).filterLight(0).canBeSilkTouched(true).breakFlowing(true).waterlogSource(true).resistance(1.8E7f).resistance(1.8E7f).build();
    public static final BlockType BAMBOO = IntBlock.builder().id(BlockIds.BAMBOO).maxStackSize(64).diggable(true).hardness(2).burnAbility(20).burnChance(5).resistance(10).translucency(1).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockSolid(false).blockMotion(false).breakFlowing(true).aabb(new SimpleAxisAlignedBB(0.5f, 0, 0.5f, 0.6875f, 1, 0.6875f)).build();
    public static final BlockType BAMBOO_SAPLING = IntBlock.builder().id(BlockIds.BAMBOO_SAPLING).maxStackSize(64).diggable(true).burnAbility(20).burnChance(5).translucency(1).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockWater(false).canBeSilkTouched(true).blockSolid(false).blockMotion(false).aabb(new SimpleAxisAlignedBB(0.1f, 0, 0.1f, 0.9f, 0.8f, 0.9f)).build();
    public static final BlockType SCAFFOLDING = IntBlock.builder().id(BlockIds.SCAFFOLDING).maxStackSize(64).diggable(true).fuelTime((short) 1200).hardness(0.6f).burnAbility(20).burnChance(60).fallable(true).flammable(true).resistance(4.5f).translucency(1).filterLight(0).canBeSilkTouched(true).blockSolid(false).blockMotion(false).breakFlowing(true).waterlogSource(true).build();
    public static final BlockType LECTERN = IntBlock.builder().id(BlockIds.LECTERN).maxStackSize(64).diggable(true).hardness(2).resistance(10).fuelTime((short) 300).burnAbility(20).burnChance(5).flammable(true).pushesOutItems(true).translucency(0.8f).targetTool(ToolTypes.AXE).filterLight(0).powerSource(true).breakFalling(true).blockSolid(false).blockMotion(false).comparatorSignal(true).breakFlowing(true).waterlogSource(true).build();
    ...
    public static final BlockType SWEET_BERRY_BUSH = IntBlock.builder().id(BlockIds.SWEET_BERRY_BUSH).maxStackSize(64).diggable(true).hardness(0.2f).burnAbility(100).burnChance(60).resistance(1).translucency(1).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).aabb(new SimpleAxisAlignedBB(0.1f, 0, 0.1f, 0.9f, 1, 0.9f)).build();
    public static final BlockType LANTERN = IntBlock.builder().id(BlockIds.LANTERN).maxStackSize(64).diggable(true).hardness(5).resistance(25).emitLight(15).translucency(0.8f).targetTool(ToolTypes.PICKAXE).filterLight(0).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).build();
    public static final BlockType CAMPFIRE = IntBlock.builder().id(BlockIds.CAMPFIRE).diggable(true).hardness(5).resistance(25).burnAbility(20).burnChance(5).translucency(1).filterLight(0).breakFalling(true).canBeSilkTouched(true).blockSolid(false).blockMotion(false).breakFlowing(true).waterlogSource(true).build();
    public static final BlockType JIGSAW = IntBlock.builder().id(BlockIds.JIGSAW).maxStackSize(64).resistance(1.8E7f).hardness(-1).pushesOutItems(true).solid(true).resistance(1.8E7f).targetTool(ToolTypes.PICKAXE).resistance(1.8E7f).blockSolid(false).blockMotion(false).breakFlowing(true).waterlogSource(true).resistance(1.8E7f).resistance(1.8E7f).build();
    public static final BlockType WOOD = IntBlock.builder().id(BlockIds.WOOD).maxStackSize(64).diggable(true).hardness(2).resistance(10).burnAbility(5).burnChance(5).flammable(true).pushesOutItems(true).solid(true).targetTool(ToolTypes.AXE).canBeSilkTouched(true).breakFlowing(true).build();
    ...
    public static final BlockType NETHER_ROOTS = IntBlock.builder().id(BlockIds.CRIMSON_ROOTS).maxStackSize(64).diggable(true).burnAbility(100).burnChance(60).translucency(1).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockWater(false).canBeSilkTouched(true).blockSolid(false).blockMotion(false).aabb(new SimpleAxisAlignedBB(0.3f, 0, 0.3f, 0.7f, 0.6f, 0.7f)).build();
    public static final BlockType NETHER_FUNGUS = IntBlock.builder().id(BlockIds.CRIMSON_FUNGUS).maxStackSize(64).diggable(true).translucency(1).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockWater(false).canBeSilkTouched(true).blockSolid(false).blockMotion(false).aabb(new SimpleAxisAlignedBB(0.27f, 0, 0.27f, 0.73f, 0.75f, 0.73f)).build();
    ...
    public static final BlockType NETHER_NYLIUM = IntBlock.builder().id(BlockIds.CRIMSON_NYLIUM).maxStackSize(64).diggable(true).hardness(0.4f).resistance(2).pushesOutItems(true).solid(true).targetTool(ToolTypes.PICKAXE).canBeSilkTouched(true).breakFlowing(true).build();
    public static final BlockType BASALT = IntBlock.builder().id(BlockIds.BASALT).maxStackSize(64).diggable(true).hardness(1).resistance(5).pushesOutItems(true).solid(true).targetTool(ToolTypes.PICKAXE).canBeSilkTouched(true).breakFlowing(true).build();
    ...
    public static final BlockType SOUL_FIRE = IntBlock.builder().id(BlockIds.SOUL_FIRE).maxStackSize(0).diggable(true).translucency(1).filterLight(0).replaceable(true).emitLight(12).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).build();
    public static final BlockType NETHER_SPROUTS = IntBlock.builder().id(BlockIds.NETHER_SPROUTS).maxStackSize(64).diggable(true).flammable(true).replaceable(true).translucency(1).targetTool(ToolTypes.AXE).filterLight(0).breakFalling(true).blockWater(false).blockSolid(false).blockMotion(false).breakFlowing(true).aabb(new SimpleAxisAlignedBB(0.15f, 0, 0.15f, 0.85f, 0.3f, 0.85f)).build();
    ...
    public static final BlockType POLISHED_BLACKSTONE_BRICKS = IntBlock.builder().id(BlockIds.POLISHED_BLACKSTONE_BRICKS).maxStackSize(64).diggable(true).hardness(1.5f).resistance(30).pushesOutItems(true).solid(true).targetTool(ToolTypes.PICKAXE).canBeSilkTouched(true).breakFlowing(true).build();
    public static final BlockType POLISHED_BLACKSTONE = IntBlock.builder().id(BlockIds.POLISHED_BLACKSTONE).maxStackSize(64).diggable(true).resistance(30).hardness(1.5f).pushesOutItems(true).solid(true).targetTool(ToolTypes.PICKAXE).canBeSilkTouched(true).breakFlowing(true).build();
    ...
    public static final BlockType CHAIN = IntBlock.builder().id(BlockIds.CHAIN).maxStackSize(64).diggable(true).hardness(5).resistance(15).translucency(0.8f).targetTool(ToolTypes.PICKAXE).filterLight(0).breakFalling(true).canBeSilkTouched(true).breakFlowing(true).waterlogSource(true).aabb(new SimpleAxisAlignedBB(0.375f, 0, 0.375f, 0.625f, 1, 0.625f)).build();
    ...
    public static final BlockType SMOOTH_STONE = IntBlock.builder().id(BlockIds.SMOOTH_STONE).maxStackSize(64).diggable(true).hardness(1.5f).resistance(30).solid(true).pushesOutItems(true).canBeSilkTouched(true).breakFlowing(true).targetTool(ToolTypes.PICKAXE).build();
    public static final BlockType POLISHED_BASALT = IntBlock.builder().id(BlockIds.POLISHED_BASALT).maxStackSize(64).diggable(true).hardness(1).resistance(5).solid(true).pushesOutItems(true).canBeSilkTouched(true).breakFlowing(true).targetTool(ToolTypes.PICKAXE).build();
    public static final BlockType CHISELED_POLISHED_BLACKSTONE = IntBlock.builder().id(BlockIds.CHISELED_POLISHED_BLACKSTONE).maxStackSize(64).diggable(true).hardness(1.5f).resistance(30).solid(true).pushesOutItems(true).canBeSilkTouched(true).breakFlowing(true).targetTool(ToolTypes.PICKAXE).build();
    public static final BlockType CRACKED_POLISHED_BLACKSTONE_BRICKS = IntBlock.builder().id(BlockIds.CRACKED_POLISHED_BLACKSTONE_BRICKS).maxStackSize(64).diggable(true).hardness(1.5f).resistance(30).solid(true).pushesOutItems(true).canBeSilkTouched(true).breakFlowing(true).targetTool(ToolTypes.PICKAXE).build();
    public static final BlockType WITHER_ROSE = IntBlock.builder().id(BlockIds.WITHER_ROSE).maxStackSize(64).diggable(true).translucency(1).burnChance(60).burnAbility(100).filterLight(0).breakFalling(true).blockWater(false).canBeSilkTouched(true).blockSolid(false).blockMotion(false).targetTool(ToolTypes.AXE).aabb(new SimpleAxisAlignedBB(0.3f, 0, 0.3f, 0.7f, 0.6f, 0.7f)).build();
    public static final BlockType STRUCTURE_VOID = IntBlock.builder().id(BlockIds.STRUCTURE_VOID).maxStackSize(64).diggable(true).build();
    ...
    private static class IntBlock implements BlockType {
        ...
        public static class IntBlockBuilder {
            ...
            private AxisAlignedBB aabb = BlockBehavior.DEFAULT_AABB;
        }
    }
}
