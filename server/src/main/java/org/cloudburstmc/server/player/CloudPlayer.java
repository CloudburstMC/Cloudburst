...
import org.cloudburstmc.api.event.server.PlayerPacketSendEvent;
...
import org.cloudburstmc.server.level.ChunkLoader;
...
//        this.sendPacket(updateBlockPropertiesPacket);
    ...
    public void processLogin() {
        ...
        for (CloudPlayer p : new ArrayList<>(this.server.getOnlinePlayers().values())) {
    ...
    public void sendPosition(Vector3f pos, double yaw, double pitch, MovePlayerPacket.Mode mode, Collection<CloudPlayer> targets) {
    ...
    protected void checkChunks() {
        ...
        if (this.chunk == null || (this.chunk.getX() != pos.getFloorX() >> 4 || this.chunk.getZ() != pos.getFloorZ() >> 4)) {
            ...
            if (!this.justCreated) {
                ...
                Set<CloudPlayer> loaders = this.chunk.getPlayerLoaders();
