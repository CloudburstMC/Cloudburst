...
public class BlockEntityTypes {
    ...
    public static final BlockEntityType<Bed> BED = BlockEntityType.from("bed", Bed.class);
    public static final BlockEntityType<Bell> BELL = BlockEntityType.from("bell", Bell.class);
    public static final BlockEntityType<BlastFurnace> BLAST_FURNACE = BlockEntityType.from("blast_furnace", BlastFurnace.class);
    public static final BlockEntityType<BrewingStand> BREWING_STAND = BlockEntityType.from("brewing_stand", BrewingStand.class);
    public static final BlockEntityType<Campfire> CAMPFIRE = BlockEntityType.from("campfire", Campfire.class);
    public static final BlockEntityType<Cauldron> CAULDRON = BlockEntityType.from("cauldron", Cauldron.class);
    ...
    public static final BlockEntityType<ItemFrame> ITEM_FRAME = BlockEntityType.from("item_frame", ItemFrame.class);
    public static final BlockEntityType<Jigsaw> JIGSAW = BlockEntityType.from("jigsaw", Jigsaw.class);
    public static final BlockEntityType<Jukebox> JUKEBOX = BlockEntityType.from("jukebox", Jukebox.class);
    public static final BlockEntityType<Lectern> LECTERN = BlockEntityType.from("lectern", Lectern.class);
    public static final BlockEntityType<MobSpawner> MOB_SPAWNER = BlockEntityType.from("mob_spawner", MobSpawner.class);
    public static final BlockEntityType<MovingBlock> MOVING_BLOCK = BlockEntityType.from("moving_block", MovingBlock.class);
    public static final BlockEntityType<NetherReactor> NETHER_REACTOR = BlockEntityType.from("nether_reactor", NetherReactor.class);
    public static final BlockEntityType<Noteblock> NOTEBLOCK = BlockEntityType.from("noteblock", Noteblock.class);
    public static final BlockEntityType<Piston> PISTON = BlockEntityType.from("piston", Piston.class);
    public static final BlockEntityType<ShulkerBox> SHULKER_BOX = BlockEntityType.from("shulker_box", ShulkerBox.class);
    public static final BlockEntityType<Sign> SIGN = BlockEntityType.from("sign", Sign.class);
