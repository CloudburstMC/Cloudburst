...
//                if (this.test(org.cloudburstmc.server.registry.BlockRegistry.get().getRuntimeId(level.getBlockAt(x + dx, y - 2, z + dz, 0)))) {
//                    level.setBlockRuntimeIdUnsafe(x + dx, y - 2, z + dz, 0, leaves);
//                }
//                if (this.test(org.cloudburstmc.server.registry.BlockRegistry.get().getRuntimeId(level.getBlockAt(x - dx + 1, y - 2, z + dz, 0)))) {
//                    level.setBlockRuntimeIdUnsafe(x - dx + 1, y - 2, z + dz, 0, leaves);
//                }
//                if (this.test(org.cloudburstmc.server.registry.BlockRegistry.get().getRuntimeId(level.getBlockAt(x + dx, y - 2, z - dz + 1, 0)))) {
//                    level.setBlockRuntimeIdUnsafe(x + dx, y - 2, z - dz + 1, 0, leaves);
//                }
//                if (this.test(org.cloudburstmc.server.registry.BlockRegistry.get().getRuntimeId(level.getBlockAt(x - dx + 1, y - 2, z - dz + 1, 0)))) {
//                    level.setBlockRuntimeIdUnsafe(x - dx + 1, y - 2, z - dz + 1, 0, leaves);
//                }
//                if ((dx > -2 || dz > -1) && (dx != -1 || dz != -2)) {
//                    if (this.test(org.cloudburstmc.server.registry.BlockRegistry.get().getRuntimeId(level.getBlockAt(x + dx, y, z + dz, 0)))) {
//                        level.setBlockRuntimeIdUnsafe(x + dx, y, z + dz, 0, leaves);
//                    }
//                    if (this.test(org.cloudburstmc.server.registry.BlockRegistry.get().getRuntimeId(level.getBlockAt(x - dx + 1, y, z + dz, 0)))) {
//                        level.setBlockRuntimeIdUnsafe(x - dx + 1, y, z + dz, 0, leaves);
//                    }
//                    if (this.test(org.cloudburstmc.server.registry.BlockRegistry.get().getRuntimeId(level.getBlockAt(x + dx, y, z - dz + 1, 0)))) {
//                        level.setBlockRuntimeIdUnsafe(x + dx, y, z - dz + 1, 0, leaves);
//                    }
//                    if (this.test(org.cloudburstmc.server.registry.BlockRegistry.get().getRuntimeId(level.getBlockAt(x - dx + 1, y, z - dz + 1, 0)))) {
...
//            if (this.test(org.cloudburstmc.server.registry.BlockRegistry.get().getRuntimeId(level.getBlockAt(x, y + 1, z, 0)))) {
//                level.setBlockRuntimeIdUnsafe(x, y + 1, z, 0, leaves);
//            }
//            if (this.test(org.cloudburstmc.server.registry.BlockRegistry.get().getRuntimeId(level.getBlockAt(x + 1, y + 1, z, 0)))) {
//                level.setBlockRuntimeIdUnsafe(x + 1, y + 1, z, 0, leaves);
//            }
//            if (this.test(org.cloudburstmc.server.registry.BlockRegistry.get().getRuntimeId(level.getBlockAt(x, y + 1, z + 1, 0)))) {
//                level.setBlockRuntimeIdUnsafe(x, y + 1, z + 1, 0, leaves);
//            }
//            if (this.test(org.cloudburstmc.server.registry.BlockRegistry.get().getRuntimeId(level.getBlockAt(x + 1, y + 1, z + 1, 0)))) {
        ...
        for (int dx = -3; dx <= 4; ++dx) {
            for (int dz = -3; dz <= 4; ++dz) {
                if ((dx != -3 || dz != -3) && (dx != -3 || dz != 4) && (dx != 4 || dz != -3) && (dx != 4 || dz != 4) && (abs(dx) < 3 || abs(dz) < 3)
                        && this.test(org.cloudburstmc.server.registry.BlockRegistry.get().getRuntimeId(level.getBlockAt(x + dx, y - 1, z + dz, 0)))) {
...
//                    if (this.test(org.cloudburstmc.server.registry.BlockRegistry.get().getRuntimeId(level.getBlockAt(x + dx, y + height - dy - 2, z + dz, 0)))) {
...
//                        if ((abs(ddx) != 2 && abs(ddz) != 2) && this.test(org.cloudburstmc.server.registry.BlockRegistry.get().getRuntimeId(level.getBlockAt(x + dx + ddx, y + height, z + dz + ddz, 0)))) {
//                            level.setBlockRuntimeIdUnsafe(x + dx + ddx, y + height, z + dz + ddz, 0, leaves);
//                        }
//                        if ((abs(ddx) != 2 || abs(ddz) != 2) && this.test(org.cloudburstmc.server.registry.BlockRegistry.get().getRuntimeId(level.getBlockAt(x + dx + ddx, y + height - 1, z + dz + ddz, 0)))) {
