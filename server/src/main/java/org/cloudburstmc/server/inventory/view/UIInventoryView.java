...
public class UIInventoryView extends InventoryView {

    public UIInventoryView(ContainerSlotType slotType, Inventory inventory) {
        super(slotType, inventory, getContainerSize(slotType), getContainerOffset(slotType));
    }
