...
public class TakeItemStackAction extends ItemStackAction {
    ...
    public TakeItemStackAction(int id, ItemStack sourceItem, int sourceSlot, ItemStack targetItem, int targetSlot) {
        super(id, sourceItem, sourceSlot, targetItem, targetSlot);
