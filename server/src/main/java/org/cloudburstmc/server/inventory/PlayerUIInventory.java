...
public class PlayerUIInventory extends BaseInventory {
    ...
    public PlayerUIInventory(CloudPlayer player) {
    ...
    @Override
    public void sendContents(CloudPlayer... target) {
